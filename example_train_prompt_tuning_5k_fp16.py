...
hard_prompt_tuning_config = PromptTuningConfig(
            ...
            prompt_tuning_init_text="Conversation between patient and doctor.",
            num_virtual_tokens=len(tokenizer("Conversation between patient and doctor.")["input_ids"]),
            )

model = get_peft_model(model, soft_prompt_tuning_config)
model.print_trainable_parameters()
output_dir="./prompt_tuning_5k_fp16/checkpoint"
...
tokenizer.save_pretrained("./prompt_tuning_5k_fp16/results")
